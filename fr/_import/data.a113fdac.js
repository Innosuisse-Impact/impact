...
export const df_waffle = await FileAttachment({"name":"../data/daten_waffle.txt","mimeType":"text/plain","path":"../_file/data/daten_waffle.c3c13d0e.txt","lastModified":1740152995443,"size":19179}, import.meta.url).tsv({ typed: true });
