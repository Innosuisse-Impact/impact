...
export const df_waffle = await FileAttachment({"name":"../data/daten_waffle.txt","mimeType":"text/plain","path":"../_file/data/daten_waffle.128aef0c.txt","lastModified":1741103895466,"size":19175}, import.meta.url).tsv({ typed: true });
