...
import { color_inst, color_subcluster, grey_innosuisse, black_innosuisse, grey_background, grey_comment, color_zufrieden, colors_dark} from "./colors.e80e8e2d.js";
...
export function coloredUnderline(text, domain) {
  ...
  return html`<span style="text-decoration: underline; text-decoration-thickness: 2px; text-underline-offset: 2px; text-decoration-color: ${color};">${text}</span>`;
}
