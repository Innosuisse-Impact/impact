...
export const df_waffle = await FileAttachment({"name":"../data/daten_waffle.txt","mimeType":"text/plain","path":"../_file/data/daten_waffle.7ba28c05.txt","lastModified":1738165989266,"size":19170}, import.meta.url).tsv({ typed: true });
...
export const df_ergebnisse = await FileAttachment({"name":"../data/daten_ergebnisse.txt","mimeType":"text/plain","path":"../_file/data/daten_ergebnisse.b22d4c6c.txt","lastModified":1738164191706,"size":14674}, import.meta.url).tsv({ typed: true });
const innovationsart = await FileAttachment({"name":"../data/daten_innovationsart.txt","mimeType":"text/plain","path":"../_file/data/daten_innovationsart.6e85d407.txt","lastModified":1738162532704,"size":10493}, import.meta.url).tsv({ typed: true });
