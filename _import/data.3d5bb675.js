...
export const df_waffle = await FileAttachment({"name":"../data/daten_waffle.txt","mimeType":"text/plain","path":"../_file/data/daten_waffle.6c6442bc.txt","lastModified":1740153343203,"size":19188}, import.meta.url).tsv({ typed: true });
