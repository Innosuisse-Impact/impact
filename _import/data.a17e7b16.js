...
export const df_waffle = await FileAttachment({"name":"../data/daten_waffle.txt","mimeType":"text/plain","path":"../_file/data/daten_waffle.56ae738b.txt","lastModified":1738231667918,"size":19213}, import.meta.url).tsv({ typed: true });
