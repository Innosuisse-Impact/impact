...
export const df_waffle = await FileAttachment({"name":"../data/daten_waffle.txt","mimeType":"text/plain","path":"../_file/data/daten_waffle.487a7b2e.txt","lastModified":1737986233163,"size":19093}, import.meta.url).tsv({ typed: true });
...
export const df_ergebnisse = await FileAttachment({"name":"../data/daten_ergebnisse.txt","mimeType":"text/plain","path":"../_file/data/daten_ergebnisse.1d5dbf16.txt","lastModified":1737987307862,"size":14702}, import.meta.url).tsv({ typed: true });
const innovationsart = await FileAttachment({"name":"../data/daten_innovationsart.txt","mimeType":"text/plain","path":"../_file/data/daten_innovationsart.f8110b7b.txt","lastModified":1737985976737,"size":10623}, import.meta.url).tsv({ typed: true });
